...
describe('Brightness Conversion', () => {
  ...
  describe('Round-trip conversion', () => {
    it('should maintain value through round-trip conversion', () => {
      ...
      const syncBox = Math.round(
        (originalHomeKit / BRIGHTNESS_MAX_HOMEKIT) * BRIGHTNESS_MAX_SYNCBOX
      );
      const backToHomeKit = Math.round(
        (syncBox / BRIGHTNESS_MAX_SYNCBOX) * BRIGHTNESS_MAX_HOMEKIT
      );
